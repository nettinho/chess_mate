defmodule ChessMate.AccountsTest do
  ...
  describe "user_roles" do
    ...
    @invalid_attrs %{rol: nil, team_prefix: nil}
    ...
    test "create_user_role/1 with valid data creates a user_role" do
      valid_attrs = %{rol: "some rol", team_prefix: "some team_prefix"}

      assert {:ok, %UserRole{} = user_role} = Accounts.create_user_role(valid_attrs)
      assert user_role.rol == "some rol"
      assert user_role.team_prefix == "some team_prefix"
    end
    ...
    test "update_user_role/2 with valid data updates the user_role" do
      user_role = user_role_fixture()
      update_attrs = %{rol: "some updated rol", team_prefix: "some updated team_prefix"}

      assert {:ok, %UserRole{} = user_role} = Accounts.update_user_role(user_role, update_attrs)
      assert user_role.rol == "some updated rol"
      assert user_role.team_prefix == "some updated team_prefix"
    end
  ...
  describe "user_roles" do
    ...
    test "create_user_role/1 with valid data creates a user_role" do
      valid_attrs = %{role: "some role", team_prefix: "some team_prefix"}
